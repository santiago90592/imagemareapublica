...
<div class="row">
  ...
  <div class="col-lg-12 grid-margin stretch-card">
    ...
    <?php echo form_open("admin/produtos/registarextras/$produto->id"); ?>
   ...
   <div class="form-row mt-5">
    ...
    <div class="col-md-8">
      ...
      <?php if(empty($produtoExtras)) : ?>
        ...
        <p>Esse produto não tem extra</p>
            ...
            <tbody>
              ...
              <?php foreach ($produtoExtras as $extraProduto): ?>
                ...
                <tr>
                  ...
                  <td><?php echo esc(number_format($extraProduto->preco, )); ?>$00&nbsp;</td>
  ...
  $(document).ready(function() {
    $('.js-example-basic-single').select2({
      ...
      "language":{
        ...
        "noResults": function (){
          return "Extra não encontrado&nbsp;&nbsp;<a class='btn btn-primary btn-sm' href='<?php echo site_url('admin/extras/criar'); ?>'>Registar</a>";
        }
