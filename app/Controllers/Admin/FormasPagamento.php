        ...
        if($this->request->getMethod() === 'post'){
            ...
            if($this->formaPagamentoModel->save($formaPagamento)){
               ...
               return redirect()->to(site_url("admin/formas/show/" . $this->formaPagamentoModel->getInsertID()))
                                ->with('sucesso', "Forma de pagamento $formaPagamento->nome registrada com sucesso");
           }else{
...
public function excluir($id = null){                         
     ...
     if($formaPagamento->deletado_em != null) {
         ...
         return redirect()->back()->with('info', "A forma de pagamento $formaPagamento->nome já foi apagada!");
    }
     ...
     $this->formaPagamentoModel->delete($id);
         ...
         return redirect()->to(site_url('admin/formas'))->with('sucesso', "Forma de pagamento $formaPagamento->nome apagada com sucesso!");
    }
...
public function desfazerExclusao($id = null){
    ...
    if ($formaPagamento->deletado_em == null){
        ...
        return redirect()->back()->with('info', 'Apenas formas de pagamento apagadas podem ser recuperadas');
    }
